...
var ErrRetrievingUserIDFromToken = errors.New("error retrieving user id from token")
var ErrParsingUUIDFromString = errors.New("error parsing uuid from string")
var ErrSigningToken = errors.New("error signing token")
